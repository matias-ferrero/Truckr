== US57: Notificación en Tiempo Real de Respuesta a mi Oferta
...
*Descripción:*
Como expedidor,
quiero recibir un aviso inmediato dentro de la aplicación cuando el transportista acepta o rechaza la oferta que le envié,
