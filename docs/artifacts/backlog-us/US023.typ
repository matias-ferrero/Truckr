...
+ El transportista puede aceptar múltiples ofertas de envío y agruparlas en un envío compuesto para una misma ventana de transporte.
+ Se muestra la ruta optimizada que contempla todos los puntos de retiro y entrega.
+ Los expedidores son agnósticos a que sus envíos formen parte de un envío compuesto.
