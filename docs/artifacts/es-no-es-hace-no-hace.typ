...
#table(
  ...
  [#align(left + horizon)[- Una plataforma de conexión entre transportistas y productores/clientes
- Un sitio web y potencialmente una app mobile]], [#align(left + horizon)[- Una empresa de traslado de personas
...
- Una red social]],
  ...
  [#align(left + horizon)[- Permite publicar ventanas de transporte
...
- Integración fiscal con ARCA]], [#align(left + horizon)[- No ofrece la compra del producto a transportar
