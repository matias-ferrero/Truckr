...
#table(
  ...
  [3],
  [Demora en implementar autenticación y roles.],
  [Negativo],
  ...
  [Flujo de registro y login no completado para al menos 2 roles al finalizar el sprint 1.],
  [Usar cuentas semilla para la demo y postergar el servicio de registro.],
  [Activo],
  [Líder técnico],
  [2026-05-08],
  ...
  [Recortar alcance al core de matching y la integración con Google Maps.],
  [Activo],
  [PM + Líder técnico],
  [2026-05-08],
)
