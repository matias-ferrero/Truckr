...
#block(
  ...
  width: 100%,
  [
    #text(weight: "bold", fill: c-warn)[Muestra pequeña (N = 2 sprints):] resultado indicativo — con tan pocos datos el bootstrap es muy sensible a valores individuales.
  ],
)
