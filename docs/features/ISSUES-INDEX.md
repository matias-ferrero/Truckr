...
| INF-INFRA-00004 | Automatización de deploy vía GitHub Actions con OIDC (infra-plan, infra-apply, backend-deploy, frontend-deploy) | IR | INFRA | 2026-05-19 | [plan](INF/INF-INFRA-00004/INF-INFRA-00004-automatizacion-de-deploy-via-github-actions-oidc.plan.md) · [#202](https://github.com/tcorzo/fiuba-gestion-tp/issues/202) |
