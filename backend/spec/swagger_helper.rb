        ...
        schemas: {
          ...
          TransportWindow: {
            ...
            properties: {
              ...
              destination_lat:         { type: :string, nullable: true },
              destination_lng:         { type: :string, nullable: true },
          ...
          CargoOffer: {
            ...
            required: %w[id cargo_id carrier_id transport_window_id amount_cents currency status expires_at]
          },
          CarrierDetail: {
            type: :object,
            properties: {
