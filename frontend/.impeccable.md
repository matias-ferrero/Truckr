...
- **Clientes**: people/businesses who need to ship something and want a fast, predictable way to request a quote and find a trustworthy carrier.
...
- **Two-sided clarity**: make it instantly obvious what Truckr® offers to clientes vs transportistas without duplicating content.
